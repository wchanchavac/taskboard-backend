...
const { capitalizeWords } = require('../helpers/methods')

const url = 'https://beta.app.symfonia.io/registry'
const app = 'Symfonia'

module.exports = ({ name, email, password, owner, enterprise }) => {
  name = capitalizeWords(name)
  owner = capitalizeWords(owner)
  enterprise = capitalizeWords(enterprise)
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        <tbody><tr>
                            ...
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                              ...
                              Hola,<br>
                              ${owner} te invitó a unirte a su empresa ${enterprise} en Symfonia.</h3>
                        ...
                        <tbody>
                            <tr>
                                <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 18px;">
                                    <a class="mcnButton " title="Aceptar invitación" href="${url}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Aceptar invitación</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
